...
public class ChestTerminal extends JavaPlugin implements Listener, SlimefunAddon {
	...
	public void onEnable() {
		...
		SlimefunItemStack wirelessTerminal16 = new SlimefunItemStack("CT_WIRELESS_ACCESS_TERMINAL_16", Material.ITEM_FRAME, "&3CT无线连接终端 &b(16)", "&8\u21E8 &7连接到: &c无", "&8\u21E8 &7范围: &e16个方块", "&c&o&8\u21E8 &e\u26A1 &70 / 10 J", "", "&7如果将此物品连接到特定CT连接终端", "&7那么将可以远程&3访问&7CT网络内任何物品", "", "&7&e手持物品右键打开CT连接终端以&7连接");
		SlimefunItemStack wirelessTerminal64 = new SlimefunItemStack("CT_WIRELESS_ACCESS_TERMINAL_64", Material.ITEM_FRAME, "&3CT无线连接终端 &b(64)", "&8\u21E8 &7连接到: &c无", "&8\u21E8 &7范围: &e64个方块", "&c&o&8\u21E8 &e\u26A1 &70 / 25 J", "", "&7如果将此物品连接到特定CT连接终端", "&7那么将可以远程&3访问&7CT网络内任何物品", "", "&7&e手持物品右键打开CT连接终端以&7连接");
		SlimefunItemStack wirelessTerminal128 = new SlimefunItemStack("CT_WIRELESS_ACCESS_TERMINAL_128", Material.ITEM_FRAME, "&3CT无线连接终端 &b(128)", "&8\u21E8 &7连接到: &c无", "&8\u21E8 &7范围: &e128个方块", "&c&o&8\u21E8 &e\u26A1 &70 / 50 J", "", "&7如果将此物品连接到特定CT终端", "&7那么将可以远程&3访问&7CT网络内任何物品", "", "&7&e手持物品右键打开CT连接终端以&7连接");
		SlimefunItemStack wirelessTerminalTransdimensional = new SlimefunItemStack("CT_WIRELESS_ACCESS_TERMINAL_TRANSDIMENSIONAL", Material.ITEM_FRAME, "&3CT无线连接终端 &b(跨维度)", "&8\u21E8 &7连接到: &c无", "&8\u21E8 &7范围: &e无限", "&c&o&8\u21E8 &e\u26A1 &70 / 50 J", "", "&7如果将此物品连接到特定CT终端", "&7那么将可以远程&3访问&7CT网络内任何物品", "", "&7&e手持物品右键打开CT连接终端以&7连接");
		
		Category category = new Category(new NamespacedKey(this, "chest_terminal"), new CustomItem(chestTerminal, "&5Chest Terminal(CT货运)", "", "&a> 单击打开"));
